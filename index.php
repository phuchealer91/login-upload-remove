                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                while($rowImg = mysqli_fetch_assoc($resultImg)) {
                                    if ($rowImg['status'] == 0) {
                                        $filename = "uploads/profile".$id."*"; // * = lay het cac gia tri dang sau, la patern nen no hoat dong vs cac ham su dung patern
                                        ...
                                        // echo $fileactualext;
                                        $pathnamefile = "uploads/profile".$id.".".$fileactualext;
                                        // echo $pathnamefile;

                                        echo '<img src="'.$pathnamefile.'" alt="" class="img-user">';
                                    } else {
                            ...
                            $sqlImg = "SELECT * FROM profileimg WHERE userid='$id'";
                                ...
                                while ($rowImg = mysqli_fetch_assoc($resultImg)) {
                                    if ($rowImg['status'] == 0) {
                                        ...
                                        echo '<img src="'.$pathnamefile.'" alt="" class="img-user selfuser">';
